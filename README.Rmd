...
3. Al final de cada ejercicio, debes escribir el **resumen del ejercicio**. Esto lo harás, a mano, en un párrafo de mínimo cuatro oraciones, explicando por qué hiciste lo que hiciste (oración 1), cómo lo hiciste (oración 2), qué obtuviste (oración 3) y qué interpretas (oración 4).
